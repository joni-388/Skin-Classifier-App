...
### App
The implementation of the app is located in the `APP Skin Classifier folder`. The app utilizes a pre-trained model generated by the accompanying notebook. By using the provided backup file, a conda environment can be set up to execute the app via `main.py`.
